...
const ROLE_OPTIONS: {
...
}[] = [
  {
    ...
    sub: "Provider",
    example:
      "We train, fine-tune, or develop our own AI models or AI-powered products.",
  },
  {
    value: "deployer",
    ...
    sub: "Deployer",
    example:
      "We integrate third-party AI (OpenAI, Azure AI, Google Gemini, etc.) into our products or workflows.",
  },
  {
    value: "both",
    label: "Both",
    ...
    example:
      "We build some AI capabilities and also integrate external AI services.",
  },
  {
    value: "unsure",
    label: "Not sure",
          ...
          <Tooltip>
            ...
            <TooltipContent side="right" className="max-w-xs">
              ...
              <p className="text-xs text-slate-300">
                <strong>Provider:</strong> Spotify building their own
                recommendation model.
                <br />
                <strong>Deployer:</strong> Spotify using a third-party
                recommendation engine via API.
              </p>
              <p className="text-xs text-slate-400 mt-1">
                This distinction matters under the EU AI Act — providers and
                deployers have different obligations.
              </p>
            </TooltipContent>
          </Tooltip>
        </div>
